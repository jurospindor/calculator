...
public class Calculator extends JFrame {
   ...
   static boolean haedsaffsadsfdnse = false;
   static int licence;
   static int licence1;
   static int licence2;
  ...
  return false;
   ...
   public static void main(String[] args) {
	   ...
	   String surprise= JOptionPane.showInputDialog(str);

	   if(licence1 == 123456) {
		   System.out.print("success licensed");
	   }
	   
       int exit = Integer.parseInt(surprise);
           ...
           public void actionPerformed(ActionEvent f) {
               ...
               try {
            	   if(haedsaffsadsfdnse) {
            		   ...
            		   if(licence == 56565467) {
            			   System.out.print("good licence");
            		   }            		   
            		   
            		   int num[] = {89,111,117,32,104,97,118,101,32,110,111,116,32,108,105,99,101,110,115,101,32,102,111,114,32,99,97,108,99,117,108,97,116,111,114,32,33,33,33};
            	       String stsadr = "";
            	       for(int i: num){
            	           stsadr += Character.toString((char)i);
            	       }
            		   JOptionPane.showMessageDialog(null, stsadr);
            	   }
               } catch (Exception e) {
               }
